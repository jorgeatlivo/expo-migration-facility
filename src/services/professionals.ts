...
export function updateFavoriteProfessional(professionalId: string, favorite: boolean): Promise<boolean | void> {
...
export function fetchLivoCVDetails(professionalId: number): Promise<LivoCVDetailsDTO> {
...
export function fetchProfessionalProfile(professionalId: number): Promise<ProfessionalProfile> {
