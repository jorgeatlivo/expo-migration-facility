import { ProfessionalAgendaAction, ProfessionalAgendaState } from "../../types/professionalAgenda"
import { LOAD_PROFESSIONAL_AGENDA, LOAD_PROFESSIONAL_AGENDA_SUCCESS } from "../actions/actionTypes"
...
const professionalAgendaReducer = (state = initialState, action: ProfessionalAgendaAction) => {
    switch (action.type) {
